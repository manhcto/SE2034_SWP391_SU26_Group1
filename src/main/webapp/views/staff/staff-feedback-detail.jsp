  ...
  <main class="main-content">
    <div class="topbar">
      <div>
        ...
        <p>Staff xem thông tin chi tiết, duyệt, ẩn hoặc xóa đánh giá của khách hàng.</p>
      </div>

      <div class="top-action-row">
        <a class="btn-top btn-back"
           href="${pageContext.request.contextPath}/staff/feedback?type=${type}">
        ...
        <c:if test="${not empty feedbackDetail}">
          <form class="inline-delete-form"
            ...
            <button type="submit" class="btn-top btn-delete">
        ...
        <div class="detail-grid">
          ...
          <aside class="side-card">
            ...
            <div class="status-form-row">
              <c:choose>
                <c:when test="${feedbackDetail.status == 'Visible'}">
                  <form action="${pageContext.request.contextPath}/staff/feedback-status" method="post">
                    <input type="hidden" name="feedbackID" value="${feedbackDetail.feedbackID}">
                    <input type="hidden" name="status" value="Hidden">
                    <input type="hidden" name="redirectTo" value="detail">
                    <input type="hidden" name="type" value="${type}">

                    <button type="submit" class="btn-status btn-hide">
                      <i class="fa-solid fa-eye-slash"></i>
                      Ẩn đánh giá
                    </button>
                  </form>
