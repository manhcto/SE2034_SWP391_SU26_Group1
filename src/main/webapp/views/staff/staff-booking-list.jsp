                                        ...
                                        <div class="action-group">
                                            <a class="icon-btn" title="Xem chi tiết"
                                               href="${pageContext.request.contextPath}/staff/booking-detail?bookingID=${booking.bookingID}">
                                                ...
                                                <%-- Staff được kết thúc hoặc hủy cả đơn đang thanh toán và đã thanh toán. --%>
                                            <c:if test="${booking.displayStatus == 'Đang thanh toán' || booking.displayStatus == 'Thanh toán thành công'}">
                                                <form class="inline-form" action="${pageContext.request.contextPath}/staff/booking-status" method="post"
                                                      onsubmit="return confirm('Bạn chắc chắn muốn đánh dấu booking này là Tour kết thúc?');">
                                                    <input type="hidden" name="bookingID" value="${booking.bookingID}">
                                                    <input type="hidden" name="status" value="End">
                                                    <input type="hidden" name="type" value="${param.type}">
                                                    <input type="hidden" name="statusFilter" value="${param.status}">
                                                    <button class="icon-btn end" type="submit" title="Đánh dấu Tour kết thúc">
