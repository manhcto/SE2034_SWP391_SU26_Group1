                ...
                <div class="detail-grid">
                    ...
                    <div class="detail-item">
                        ...
                        <span class="detail-value">
                            <c:choose>
                                <c:when test="${bookingDetail.status == 'Đang xử lý' || bookingDetail.status == 'Pending' || bookingDetail.status == 'Đang thanh toán' || bookingDetail.status == 'Đang đợi chuyển khoản'}">
                                    <span class="status-pill status-pending">Đang thanh toán</span>
                                </c:when>
                                <c:when test="${bookingDetail.status == 'Đã duyệt' || bookingDetail.status == 'Confirmed' || bookingDetail.status == 'Hoàn thành' || bookingDetail.status == 'Completed' || bookingDetail.status == 'Thanh toán thành công' || bookingDetail.status == 'Đã booking và thanh toán thành công'}">
