...
<head>
    ...
    <style>
        ...
        .duplicate-row,.warning-row{background:#fff7ed}.duplicate-chip,.price-warning-chip{display:inline-flex;align-items:center;gap:6px;margin-top:5px;padding:4px 7px;border-radius:999px;background:#ffedd5;color:#c2410c;font-size:11px;font-weight:900}
        ...
        <c:if test="${!allSchedules}">
            <section class="page-card">
                <div class="section-body">
                    ...
                    <c:if test="${(tour.status == 'Draft' || tour.status == 'Rejected') && empty readinessErrors}">
                        <div class="mt-3 d-flex justify-content-end">
                            <a class="btn-main" href="${pageContext.request.contextPath}/staff/tour/detail?id=${tour.tourID}">
                                <i class="fa-solid fa-eye"></i> Xem chi tiết trước khi gửi duyệt
                            </a>
                        </div>
                    </c:if>
                </div>
                        ...
                        <c:otherwise>
                            <div class="table-wrap">
                                <table class="table data-table align-middle">
                                    ...
                                    <tbody>
                                    <c:forEach var="item" items="${tourList}" varStatus="loop">
                                        <tr>
