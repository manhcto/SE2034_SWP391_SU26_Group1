...
<div class="feedback-page">
    <section class="page-hero">
        ...
        <c:choose>
            <c:when test="${not empty serviceName}">
                <h1>Đánh giá ${serviceName}</h1>
                <p>
                    Chia sẻ trải nghiệm thực tế của bạn để giúp những khách hàng khác lựa chọn dịch vụ phù hợp hơn.
                    Đánh giá sau khi gửi sẽ được nhân viên duyệt trước khi công khai.
                </p>
            </c:when>
            ...
            <c:otherwise>
                ...
                <p>
                    Vui lòng chọn dịch vụ hợp lệ trước khi gửi đánh giá.
                </p>
            </c:otherwise>
        </c:choose>
        ...
        <div class="hero-info-row">
            ...
            <c:if test="${bookingID > 0}">
                <div class="hero-info-pill">
                    ...
                    <span>Đã tìm thấy đặt chỗ phù hợp</span>
                </div>
            </c:if>
        </div>
    </section>
    ...
    <c:if test="${canSubmitFeedback == false}">
        <div class="notice-box notice-info">
            <i class="fa-solid fa-circle-info"></i>
            Bạn cần đặt dịch vụ này trước khi gửi đánh giá. Nếu bạn vừa đặt dịch vụ, hãy kiểm tra lại tài khoản đang đăng nhập.
        </div>
    </c:if>
    ...
    <div class="layout-grid">
            ...
            <form action="${pageContext.request.contextPath}/feedback-add" method="post">
                ...
                <div class="form-group">
                    ...
                    <div class="rating-select-wrap">
                        ...
                        <label class="rating-option">
                            <input type="radio" name="rate" value="3" ${empty feedback || feedback.rate == 0 || feedback.rate == 3 ? 'checked' : ''}>
                            <span class="rating-box">
                                <i class="fa-solid fa-star"></i>
                                3
                            </span>
                ...
                <div class="form-group">
                    ...
                    <div class="form-note">
                        Tối đa 1000 ký tự. Nội dung nên rõ ràng, lịch sự và đúng trải nghiệm thực tế.
                    </div>
                </div>
        ...
        <aside class="side-card">
            ...
            <div class="side-info-list">
                ...
                <div class="side-info-item">
                    <div class="side-label">Khu vực</div>
                    <div class="side-value">
                        <c:choose>
                ...
                <div class="side-info-item">
                    <div class="side-label">Trạng thái đánh giá</div>
                    <div class="side-value">
                        Chờ nhân viên duyệt
                    </div>
                </div>
            ...
            <div class="rules-box">
                <div class="rule-item">
                    ...
                    <span>Chỉ khách hàng đã đặt dịch vụ mới có thể gửi đánh giá.</span>
                </div>

                <div class="rule-item">
                    <i class="fa-solid fa-check-circle"></i>
                    <span>Đánh giá mới sẽ ở trạng thái chờ duyệt trước khi hiển thị công khai.</span>
                </div>

                <div class="rule-item">
                    <i class="fa-solid fa-check-circle"></i>
                    <span>Bạn có thể sửa lại đánh giá của mình sau khi gửi.</span>
                </div>
            </div>
        </aside>
    </div>
