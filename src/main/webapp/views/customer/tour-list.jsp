...
<head>
    ...
    <style>
        ...
        .tour-more { display: block; margin-top: 10px; color: #e6007e !important; text-align: right; font-size: 13px; font-weight: 700; }
        ...
        .tour-count-title { margin: 0 0 16px; padding-bottom: 8px; border-bottom: 1px solid #e6007e; color: #e6007e; font-size: 18px; line-height: 1.3; text-transform: uppercase; }
        ...
        .departure-chip { padding: 6px 8px; border: 1px solid #e6007e; border-radius: 5px; color: #e6007e; background: #ffffff; font-size: 12px; line-height: 1; }
        ...
        .tour-result-price { display: block; color: #e6007e; font-size: 23px; line-height: 1.1; font-weight: 800; }
        .detail-button { min-width: 100px; min-height: 38px; padding: 0 14px; border-radius: 8px; color: #ffffff; background: #c02ca2; display: inline-flex; align-items: center; justify-content: center; text-decoration: none; font-size: 13px; font-weight: 900; }
        .detail-button:hover { background: #e6007e; color: #ffffff; }
        ...
        .filter-form button { height: 42px; border: 0; border-radius: 4px; color: #ffffff; background: #e6007e; font-weight: 900; cursor: pointer; }
