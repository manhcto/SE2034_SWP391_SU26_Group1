...
<div class="admin-layout">
    ...
    <main class="main-content">
        ...
        <section class="content-card">
            <form class="filter-grid" method="get" action="${pageContext.request.contextPath}${approvalPage ? '/admin/tour/approval' : '/admin/tour'}">
                ...
                <c:otherwise>
                    <div class="table-responsive">
                        <table class="table align-middle">
                            <thead>
                            <tr>
                                <th>Mã tour</th><th>Tên tour</th><th>Danh mục</th><th>Khu vực</th><th>Điểm đi/đến</th><th>Lịch</th><th>Booking</th><th>Giá</th><th>Trạng thái</th><th>Thao tác</th>
                            </tr>
                            </thead>
                            <tbody>
                            <c:forEach var="tour" items="${tours}">
                                <tr>
                                    ...
                                    <td>
                                        <a class="action-link" href="${pageContext.request.contextPath}/admin/tour/detail?id=${tour.tourID}">Xem</a>
