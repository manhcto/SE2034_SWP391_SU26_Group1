                ...
                <div class="detail-grid">
                    ...
                    <span class="status-badge status-hidden">
                      ...
                      Đang ẩn
                            ...
                            <div class="info-box">
                                <div class="info-label">Loại đơn đặt</div>
                                <div class="info-value">
                                    <c:choose>
                                        <c:when test="${feedbackDetail.bookingType == 'Tour'}">Đặt tour</c:when>
                                        <c:when test="${feedbackDetail.bookingType == 'Accommodation'}">Đặt phòng</c:when>
                                        <c:when test="${feedbackDetail.bookingType == 'Vehicle'}">Đặt xe</c:when>
                    ...
                    <aside class="side-card">
                        ...
                        <div class="side-info-list">
                            ...
                            <div class="side-info-item">
                                <div class="side-label">Mã đặt chỗ</div>
                                <div class="side-value">${feedbackDetail.bookingCode}</div>
                            </div>

                            <div class="side-info-item">
                                <div class="side-label">Trạng thái đơn đặt</div>
                                <div class="side-value">
                                    <c:choose>
                                        <c:when test="${feedbackDetail.bookingStatus == 'Confirmed'}">Đang diễn ra</c:when>
                                        <c:when test="${feedbackDetail.bookingStatus == 'Cancelled'}">Đã hủy</c:when>
                                        <c:when test="${feedbackDetail.bookingStatus == 'Completed'}">Đã hoàn thành</c:when>
                                        <c:otherwise>${feedbackDetail.bookingStatus}</c:otherwise>
                                    </c:choose>
                                </div>
                            </div>
